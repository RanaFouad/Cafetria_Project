    ...
    $("#confirm").click(function(e){
        ...
        $("#table tr").each(function(e)
        {
           ...
           pro_id=$(this).attr('data');
            ...
            data={"notes":notes,"userid":user_id,"roomno":room_number,"prodid":product_id_array,"amount":product_amount_array,"totalprice":total_price_array};
            ...
            $.ajax
            ({
                url: "ajax-files/last_order_order_user_ajax.php",
                method: 'get',
                data: {"user_id":user_id},
                success: function (response) {
                    $("#latest_order").html(response);
                    $("#not_select").html("");
                    choosen_product = [];
                    choosen_product_array_length=0;
                    product_id_array=[];
                    ...
                    single_price=0;
                    total_price=0;
                    $("[name = image_div1]").bind("click",image_click);
                    index=0;
                }
            });
